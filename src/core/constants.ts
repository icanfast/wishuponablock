...
export const SPAWN_DANGER_LOCK_DELAY_BONUS_MS = 250;
export const SPAWN_DANGER_HARD_LOCK_DELAY_BONUS_MS = 250;
...
export const ML_MODEL_URL = `${BASE_URL}models/model_v4.json`;
